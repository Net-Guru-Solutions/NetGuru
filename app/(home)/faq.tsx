      ...
      <div className=" p-10 md:p-4 md:px-20">
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-black" >What is Net Guru?</AccordionTrigger>
            <AccordionContent className="text-gray-600">
              Net Guru is a team of creatives who are excited to help you grow your business.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger className="text-black">How to start?</AccordionTrigger>
            <AccordionContent className="text-gray-600">
