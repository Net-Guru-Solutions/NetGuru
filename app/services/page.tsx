...
const plans = [
	{
		...
		description:
			"Entry-level plan for small businesses or startups needing a more comprehensive website solution.",
		button: "Buy Now",
	},
	{
		index: 1,
		...
		style:
			" h-full rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
		description:
			"Ideal for growing businesses or organizations requiring additional features and functionality.",
		button: "Buy Now",
	},
	{
		index: 2,
		...
		style:
			" h-full rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
		description:
			"Tailored for businesses seeking advanced features and marketing capabilities.",
		button: "Buy Now",
	},
	{
		index: 3,
		...
		style:
			" h-full rounded-3xl py-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-300 to-neutral-50",
		description:
			"Comprehensive package designed for established businesses or enterprises requiring extensive website solutions.",
		button: "Contact Us",
	},
];
