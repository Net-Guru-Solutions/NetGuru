...
const ProjectUpdateEmail: React.FC<ProjectUpdateEmailProps> = ({ firstName, projectName, update }) => (
  <Html>
    <Head />
    <Preview>Update on {projectName}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src="https://example.com/logo.png" alt="Net Guru Solutions" style={logo} />
        <Heading style={heading}>Project Update: {projectName}</Heading>
        <Section style={section}>
          <Text style={paragraph}>Hi {firstName},</Text>
          <Text style={paragraph}>Here is the latest update on your project, {projectName}:</Text>
          <Text style={paragraph}>{update}</Text>
