...
const ThankYouEmail: React.FC<ThankYouEmailProps> = ({ firstName, projectName }) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={heading}>Thank You for Your Business, {firstName}!</Heading>
        <Section style={section}>
          <Text style={paragraph}>Hi {firstName},</Text>
          <Text style={paragraph}>
            We wanted to take a moment to thank you for entrusting us with your project, {projectName}. We look forward to continuing our work together.
          </Text>
