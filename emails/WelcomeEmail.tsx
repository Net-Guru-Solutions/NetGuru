...
const WelcomeEmail: React.FC<WelcomeEmailProps> = ({ firstName }) => (
  <Html>
    <Head />
    <Preview>Welcome to Net Guru Solutions!</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src="https://example.com/logo.png" alt="Net Guru Solutions" style={logo} />
        <Heading style={heading}>Welcome to Net Guru Solutions, {firstName}!</Heading>
        <Section style={section}>
          <Text style={paragraph}>Hi {firstName},</Text>
          <Text style={paragraph}>
            Thank you for choosing us for your digital needs. We are excited to have you on board and look forward to working with you.
          </Text>
